-- Código SQL corregido para crear el sistema de módulos
-- COPIA Y PEGA ESTE CÓDIGO EN SUPABASE
...
-- Políticas RLS para tabla modules
...
-- Políticas RLS para tabla module_data
