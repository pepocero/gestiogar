-- SQL para crear SOLO las tablas nuevas sin tocar policies existentes
-- Ejecuta este código si ya tienes otras policies funcionando
...
-- Crear función user_company_id si no existe (sin tocar si ya existe)
...
DO $$ 
BEGIN
    -- Políticas para tabla modules
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'modules' AND policyname = 'Users can view their company modules'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'modules' AND policyname = 'Users can create modules for their company'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'modules' AND policyname = 'Users can update their company modules'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'modules' AND policyname = 'Users can delete their company modules'
    ) THEN
...
-- Políticas para tabla module_data
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'module_data' AND policyname = 'Users can view their company module data'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'module_data' AND policyname = 'Users can create module data for their company'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'module_data' AND policyname = 'Users can update their company module data'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'module_data' AND policyname = 'Users can delete their company module data'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE trigger_name = 'update_modules_updated_at' AND event_object_table = 'modules'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.triggers 
        WHERE trigger_name = 'update_module_data_updated_at' AND event_object_table = 'module_data'
    ) THEN
